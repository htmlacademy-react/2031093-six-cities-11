...
function ReviewForm({ onSubmit }: ReviewFormProps): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <textarea onChange={handleChangeText} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" value={formData.text}></textarea>
